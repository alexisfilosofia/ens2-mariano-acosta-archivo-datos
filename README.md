...
Repositorio público de investigación y divulgación del Archivo Escolar de la ENS N.º 2 "Mariano Acosta" para la serie 1910-1915.

## Paper 3

Los materiales metodológicos reproducibles están en `paper3_metodos/`. La versión científica es `v1.2-paper3`.
